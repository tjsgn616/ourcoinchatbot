...
def si():
    ...
    top_acc_val.to_csv("data/top_acc.csv",index=True, header = True)
    ...
    live_coin.to_csv("data/live_top.csv",index=True, header=True)
    ...
    top_change_val.to_csv("data/top_change.csv",index=True, header = True)
